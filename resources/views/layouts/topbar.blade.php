<div class="d-flex align-items-center">
          ...
          <div class="dropdown pull-right hidden-md-down">
            <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <img src="{{ asset('assets/img/profiles/avatar.jpg') }}" alt="" data-src="{{ asset('assets/img/profiles/avatar.jpg') }}" width="32" height="32">
              </span>
            </button>
            <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
              <a href="/user/setting" class="dropdown-item"><i class="pg-settings_small"></i> Settings</a>
              <a href="/user/feedback" class="dropdown-item"><i class="pg-outdent"></i> Feedback</a>
              <a href="/user/help" class="dropdown-item"><i class="pg-signals"></i> Help</a>
