        ...
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          ...
          <form id="form-login" onsubmit="return false" class="p-t-15" role="form" method="post" action="">
            ...
            <div class="form-group form-group-default">
              ...
              <div class="controls">
                <input type="password" class="form-control" id="pass" name="password" placeholder="Credentials" required>
              </div>
            </div>
            <!-- START Form Control-->
            <div class="row">
              <div class="col-md-6 no-padding sm-p-l-10">
                <div class="checkbox ">
                  ...
                  <label for="checkbox1">Don't Remember Me</label>
                </div>
              </div>
              <div class="col-md-6 d-flex align-items-center justify-content-end">
                <a href="help" class="text-info small">Help? Contact Support</a>
              </div>
            </div>
            <!-- END Form Control-->
            <button class="btn btn-primary btn-cons m-t-10" onclick="return login()" type="submit">Sign in</button>
          </form>
          <!--END Login Form-->
